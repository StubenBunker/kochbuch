...
export const recipes: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      { name: 'Tiefkühlerbsen', amount: 25, unit: 'g', category: K, group: 'Für die Soße' },
      ...
      { name: 'Hefeflocken', amount: 0.4, unit: 'EL', category: S, group: 'Für die Béchamel' },
      { name: 'Veganer Streukäse', amount: 25, unit: 'g', category: S, group: 'Für die Béchamel' },
